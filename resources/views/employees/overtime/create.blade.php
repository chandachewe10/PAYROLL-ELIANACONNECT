...
<form action="{{ route('employees.overtime_details_submit') }}" method="POST" >
                    @csrf
                    <div class="row">
                      ...
                      <div class="col-md-12 col-lg-12 col-sm-12">
                       <div class="form-group">
                        ...
                        <select class="form-control" name="employee_id" id="employee_id">
                            ...
                            <option value="{{Auth::guard('Employees')->user()->email}}">{{Auth::guard('Employees')->user()->first_name}} {{Auth::guard('Employees')->user()->last_name}}</option>
                    ...
                    <div class="row">
                      <div class="col-md-6 col-lg-6 col-sm-12">
                       <div class="form-group">
                        ...
                        <input type="text" name="rate_amount" value="{{Auth::guard('Employees')->user()->rate_per_hour}}" class="form-control" id="rate_amount" readonly>
