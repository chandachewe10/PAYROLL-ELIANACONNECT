...
<button type="button" class="btn btn-info btn-lg btn-block"><i class="fa fa-map-marker"></i><a style="color:white" href="{{route("employees.sign_in")}}"> Check In</a></button>
                              ...
                              Checked Out: {{ $logged_out->time_out }}
                                     @else 
                                     <button type="button" class="btn btn-danger btn-lg btn-block"><i class="fa fa-map-marker"></i><a style="color:white" href="{{route("employees.sign_out")}}"> Check Out</a></button>
