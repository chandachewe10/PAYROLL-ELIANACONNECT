...
<div class="authentication-form mx-auto">
    ...
    <form action="{{ route('agent.register') }}" method="post">
        ...
        <div class="form-group">
            <input type="number" name="employee_phone_number" value="{{ old('employee_phone_number') }}" class="form-control" placeholder="Agent Phone Number" required="">
            <i class="fas fa-phone"></i>
        </div>
        <div class="form-group">
            <input type="text" name="employee_email" value="{{ old('employee_email') }}" class="form-control" placeholder="Agent Email" required="">
