...
@section('title') Register | E-System Admin  @endsection
...
<div class="authentication-form mx-auto">
    ...
    <form action="{{ route('register') }}" method="post">
        ...
        <div class="form-group">
            <input type="text" name="company_address" value="{{ old('company_address') }}" class="form-control" placeholder="Company Address" required="">
            <i class="fas fa-map-marker-alt"></i>
        </div>
        <div class="form-group">
            <input type="text" name="email" value="{{ old('email') }}" class="form-control" placeholder="Company Email" required="">
            <i class="fa fa-envelope"></i>
        </div>
      
       <div class="form-group">
            <input type="text" name="company_tpin" value="{{ old('tpin') }}" class="form-control" placeholder="Registration Number" required="">
