...
@section('title') Allowance @endsection
  ...
  <div class="row align-items-end">
    <div class="col-lg-8">
      <div class="page-header-title">
        ...
        <div class="d-inline">
          <h5>Allowance</h5>
          <span>You can show and manage Allowance from here.</span>
        </div>
      </div>
    </div>
    <div class="col-lg-4">
      <nav class="breadcrumb-container" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">List of Allowance</li>
        </ol>
      </nav>
    </div>
  </div>
