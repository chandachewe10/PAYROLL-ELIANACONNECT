        ...
        <div class="widget overflow-visible">
            ...
            <div class="widget-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="Deduction">
                        <h5 class="text-secondary">Create Allowance</h5>
                    </div>
                </div>

                <form action="{{ $form_store }}" method="POST" id="createAllowance">
                    @csrf
                    <div class="form-group">
                        <label for="name">Name</label><small class="text-danger">*</small>
                        <input type="text" name="name" class="form-control" id="name" placeholder="ex: Standard Allowance" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" id="description" name="description" placeholder="Some description about Allowance..."></textarea>
...
$(document).ready(function($) {
  $("#createAllowance").submit(function(event){
    event.preventDefault();
    createForm("#createAllowance");
  });
});
</script>
@endsection