...
@section('title') {{ $deduction->title }} - Edit Third Party Service Provider @endsection
        ...
        <div class="widget overflow-visible">
            ...
            <div class="widget-body">
                <div class="overlay hidden">
                    ...
                    <span class="overlay-text">Service Provider {{ $deduction->name }} Updating...</span>
                </div>
                <div class="d-flex justify-content-between align-items-center">
                    <div class="Deduction">
                        <h5 class="text-secondary">Edit {{ $deduction->name }} Service Provider</h5>
                    </div>
                </div>
                ...
                <form action="{{ $form_update }}" method="POST" id="editDeduction">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="deduction_code" class="form-control" id="deduction_code" placeholder="999" autocomplete="off" value="{{ $deduction->deduction_code }}">
