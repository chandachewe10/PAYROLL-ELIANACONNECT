  ...
  <div class="row align-items-end">
     <div class="col-lg-8">
        <div class="page-header-title">
           ...
           <div class="d-inline">
              <h5>Create</h5>
              <span>Create Positions, Upload and Submit the csv File.</span>
          </div>
      </div>
  </div>
  <div class="col-lg-4">
    ...
    <div class="col-md-6 col-sm-12 col-xl-6 offset-md-3 offset-xl-3">
        ...
        <div class="widget overflow-visible">
            ...
            <div class="widget-body">
                ...
                <form action="{{ route('import_csv') }}" method="POST" id="createPosition">
                    @csrf
                    <div class="form-group">
                        <label for="title">Upload Positions in CSV File</label><small class="text-danger">*</small>
                        <input type="file" name="file" class="form-control" id="title" autocomplete="off">
                        <small class="text-danger err" id="title-err"></small>
                    </div>
