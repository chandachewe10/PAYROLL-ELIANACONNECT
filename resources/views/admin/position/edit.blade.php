            ...
            <div class="widget-body">
                ...
                <form action="{{ $form_update }}" method="POST" id="editPosition">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="salary_scale" class="form-control" id="title" placeholder="Salary Scale"  autocomplete="off" value="{{ $position->salary_scale }}">
                        <small class="text-danger err" id="title-err"></small>
                    </div>

                    <div class="form-group">
                        <label for="title">Vacancies</label><small class="text-danger">*</small>
                        <input type="text" name="vacancies" class="form-control" id="title" placeholder="Vacancies"  autocomplete="off" value="{{ $position->vacancies }}">
                        <small class="text-danger err" id="title-err"></small>
                    </div>

                    <div class="form-group">
                        <label for="title">Head Count</label><small class="text-danger">*</small>
                        <input type="text" name="head_count" class="form-control" id="title" placeholder="Head Count"  autocomplete="off" value="{{ $position->head_count }}">
                        <small class="text-danger err" id="title-err"></small>
                    </div>

                    <div class="form-group">
                        <label for="title">Transport Allowance</label><small class="text-danger">*</small>
                        <input type="text" name="transport_allowance" class="form-control" id="title" placeholder="Transport Allowance"  autocomplete="off" value="{{ $position->transport_allowance }}">
                        <small class="text-danger err" id="title-err"></small>
                    </div>

                    <div class="form-group">
                        <label for="title">Housing Allowance</label><small class="text-danger">*</small>
                        <input type="text" name="housing_allowance" class="form-control" id="title" placeholder="Housing Allowance"  autocomplete="off" value="{{ $position->housing_allowance }}">
                        <small class="text-danger err" id="title-err"></small>
                    </div>
