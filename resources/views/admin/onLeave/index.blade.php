...
@section('title') Leave Days @endsection
    ...
    <div class="col-lg-8">
      <div class="page-header-title">
        ...
        <div class="d-inline">
          ...
          <span>You can view and manage Employees on Leave from here.</span>
        </div>
      </div>
    </div>
    <div class="col-lg-4">
      <nav class="breadcrumb-container" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            <a href="{{ route('admin.cashadvance.index') }}">Leave Days</a>
          </li>
          <li class="breadcrumb-item active" aria-current="page">Employees on Leave</li>
        </ol>
      </nav>
    </div>
  </div>
