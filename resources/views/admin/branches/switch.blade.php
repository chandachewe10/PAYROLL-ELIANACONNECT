...
@section('title') Switch to another Company Branch @endsection
  ...
  <div class="col-lg-4">
    <nav class="breadcrumb-container" aria-label="breadcrumb">
       <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item">
             <a href="{{ route('admin.branches.create') }}">Choose Branch</a>
         </li>
    ...
    <div class="col-md-6 col-sm-12 col-xl-6 offset-md-3 offset-xl-3">
        ...
        <div class="widget overflow-visible">
            ...
            <div class="widget-body">
                ...
                <form action="{{ $form_store }}" method="POST" id="pickBranch">
                    @csrf
