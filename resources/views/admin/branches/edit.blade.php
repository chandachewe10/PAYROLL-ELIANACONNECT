  ...
  <div class="col-lg-4">
    <nav class="breadcrumb-container" aria-label="breadcrumb">
       <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item">
             <a href="{{ route('admin.branches.create') }}">Edit a Branch</a>
         </li>
         <li class="breadcrumb-item active" aria-current="page">Create</li>
     </ol>
 </nav>
    ...
    <div class="col-md-6 col-sm-12 col-xl-6 offset-md-3 offset-xl-3">
        ...
        <div class="widget overflow-visible">
            ...
            <div class="widget-body">
                <div class="overlay hidden">
                    <i class="ik ik-refresh-ccw loading"></i>
                    <span class="overlay-text">Editing a branch...</span>
                </div>
                <div class="d-flex justify-content-between align-items-center">
                    <div class="position">
                        <h5 class="text-secondary">Edit a Branch </h5>
                    </div>
                </div>

                <form action="{{ $form_store }}" method="POST" id="editBranch">
                    @csrf
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="branch_location" value="{{$branch_location}}" />
                        <small class="text-danger err" id="agenda-err">State/Province</small>
                    </div>
                    

                    <input type="hidden" class="form-control" name="branch_id" value="{{$branch_id}}" />
