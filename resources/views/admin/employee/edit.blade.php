...
@endphp
                       ...
                       <div class="form-group">
                        ...
                        <select class="form-control" name="branch_name" >  
                          ...
                          @foreach($branches as $branch)    
                            ...
                            <option  @if($branch->branch_id == $employee->branch_name)
                                selected
      ...
      <input type="text" class="form-control datetimepicker-input" name="employee_start_date" id="start_date"  data-toggle="datetimepicker" data-target="#start_date" value="{{date('Y-m-d', strtotime($employee->employee_start_date))}}" required>
...
<div class="col-md-6 col-lg-6 col-sm-12">   
  <div class="form-group">
      ...
      <input type="text" class="form-control datetimepicker-input" name="employee_end_date" id="end_date" data-toggle="datetimepicker" data-target="#end_date"  value="{{$employee->employee_end_date == 'PERMANENT' ? 'PERMANENT' : date('Y-m-d', strtotime($employee->employee_end_date))}}">
