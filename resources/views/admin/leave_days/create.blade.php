...
@section('title') Create Leave @endsection
  ...
  <div class="row align-items-end">
     <div class="col-lg-8">
        <div class="page-header-title">
           ...
           <div class="d-inline">
              <h5>Leave Days</h5>
              <span>Creating Leaves, Please fill all field correctly.</span>
          </div>
      </div>
  </div>
  <div class="col-lg-4">
    <nav class="breadcrumb-container" aria-label="breadcrumb">
       <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item">
             <a href="{{ route('admin.leave_days.index') }}">Leave Days</a>
         </li>
        ...
        <div class="widget overflow-visible">
            ...
            <div class="widget-body">
                <div class="overlay hidden">
                    ...
                    <span class="overlay-text">New Leave Creating...</span>
                </div>
                    ...
                    <div class="row">
                      <div class="col-md-8 col-lg-8 col-sm-12">
                       <div class="form-group">
                        ...
                        <input type="text" name="leave_name" class="form-control" id="title" placeholder="Some Title or Reason for Leave" autocomplete="off">
                        <small class="text-danger err" id="title-err"></small>
                      </div>
                      </div>
                      <div class="col-md-4 col-lg-4 col-sm-12">
                        <div class="form-group">
                          <label for="date">Leave Date</label><small class="text-danger">*</small>
