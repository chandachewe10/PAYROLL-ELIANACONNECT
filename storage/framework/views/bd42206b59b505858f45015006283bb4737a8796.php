            ...
            <header class="header-top" header-theme="light">
                <div class="container-fluid">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="top-menu d-flex align-items-center">
                            <div class="">
                                <span class="text-secondary mr-2"><?php echo e(Auth::user()->username); ?></span>
                            </div>
                            <div class="dropdown">
                            
                               <?php if(!empty(Auth::user()->principle_passport_photo)): ?>
                            <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="avatar" src="<?php echo e(asset('LOGOS_UPLOADS/'.Auth::user()->principle_passport_photo)); ?>" alt="Principal Passport Photo"></a>

<?php else: ?>

                                <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="avatar" src="<?php echo e(asset('admin_assets/avatars/admin/admin.png')); ?>" alt="Principal Passport Photo"></a>
           ...
           <?php endif; ?>      
                               ...
                               <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                                    <a class="dropdown-item" href="<?php echo e(route('admin.profile.index')); ?>"><i class="ik ik-user dropdown-icon"></i> Profile</a>
            ...
            <div class="page-wrap">
                ...
                <footer class="footer">
                    <div class="w-100 clearfix">
                        <span class="text-center text-sm-left d-md-inline-block">copyright@ <?php echo e(date('Y')); ?> - ElianaConnect.</span>
...
var countDownDate = new Date("<?php echo e(Auth::user()->payments_made_at); ?>").getTime();
...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    ...
    window.location.href = "<?php echo e(route('admin.subscriptionExpired')); ?>";
  }
}, 1000);
</script>
       ...
       <!--End countdown timer-->
        ...
        <script src="<?php echo e(asset('admin_assets/plugins/select2/dist/js/select2.min.js')); ?>" ></script>
        <script src="<?php echo e(asset('admin_assets/plugins/summernote/dist/summernote-bs4.min.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/plugins/ckeditor5/build/ckeditor.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/plugins/screenfull/dist/screenfull.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/plugins/datatables.net/js/jquery.dataTables.min.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/plugins/datatables.net-bs4/js/dataTables.bootstrap4.min.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/plugins/datatables.net-responsive/js/dataTables.responsive.min.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/plugins/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/plugins/moment/moment.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/plugins/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/plugins/jquery-minicolors/jquery.minicolors.min.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/plugins/d3/dist/d3.min.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/plugins/c3/c3.min.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/js/tables.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/js/widgets.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/js/charts.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/plugins/mohithg-switchery/dist/switchery.min.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/plugins/jquery-toast-plugin/dist/jquery.toast.min.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/plugins/JQuery-mask-plugin/jquery.mask.min.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/plugins/owl.carousel/dist/owl.carousel.min.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/plugins/json-viewer/jquery.json-viewer.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/plugins/jquery.repeater/jquery.form-repeater.min.js')); ?>"></script>
...
<!--Datatables Buttons ends here-->
        ...
        <script src="<?php echo e(asset('admin_assets/plugins/sweetalert/dist/sweetalert.min.js')); ?>"></script>
        <script src="<?php echo e(asset('admin_assets/dist/js/theme.min.js')); ?>"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/croppie/2.6.2/croppie.js"></script>
        <script type="text/javascript" src="<?php echo e(asset('admin_assets/src/js/site-scripts.js')); ?>"></script>
...
<?php /**PATH /homepages/22/d934631494/htdocs/PAYROLL2/resources/views/admin/layout/app.blade.php ENDPATH**/ ?>