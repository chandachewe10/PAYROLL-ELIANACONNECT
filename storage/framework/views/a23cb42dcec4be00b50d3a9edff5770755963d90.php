            ...
            <div class="row">
              <div class="col-md-4" data-aos="fade-up" data-aos-delay="600">
                <div class="media block-icon-1 d-block text-left">
                  <div class="icon mb-3">
                    <img src="<?php echo e(asset('landing_page/images/flaticon/svg/001-consultation.svg')); ?>" alt="Image" class="img-fluid">
                  </div>
                  <div class="media-body">
                    <h3 class="h5 mb-4">Record Management</h3>
                    <p>Stores and records all pieces of information related to your employees.</p>
                    <p data-aos="fade-up" data-aos-delay="200"><a href="<?php echo e(route('register')); ?>" class="btn btn-primary py-3 px-4 mr-3">Get Started</a></p> 
                  </div>
                </div> <!-- .block-icon-1 -->
              </div>
              <div class="col-md-4" data-aos="fade-up" data-aos-delay="700">
                <div class="media block-icon-1 d-block text-left">
                  <div class="icon mb-3">
                    <img src="<?php echo e(asset('landing_page/images/flaticon/svg/002-discussion.svg')); ?>" alt="Image" class="img-fluid">
                  </div>
                  <div class="media-body">
              ...
              <div class="col-md-4" data-aos="fade-up" data-aos-delay="800">
                <div class="media block-icon-1 d-block text-left">
                  <div class="icon mb-3">
                    <img src="<?php echo e(asset('landing_page/images/flaticon/svg/003-turnover.svg')); ?>" alt="Image" class="img-fluid">
                  </div>
                  <div class="media-body">
        ...
        <div class="row">
          <div class="col-lg-7">
            ...
            <div class="owl-carousel wide-slider">
              <div class="item">
                <img src="<?php echo e(asset('landing_page/images/slider-1.jpg')); ?>" alt="Free template by TemplateUX.com" class="img-fluid">
              </div>
              <div class="item">
                <img src="<?php echo e(asset('landing_page/images/slider-2.jpg')); ?>" alt="Free template by TemplateUX.com" class="img-fluid">
              </div>
              <div class="item">
                <img src="<?php echo e(asset('landing_page/images/slider-3.jpg')); ?>" alt="Free template by TemplateUX.com" class="img-fluid">
              </div>
            </div> <!-- .owl-carousel -->
          </div>
...
<!--
      ...
      <div class="row mb-5">
        ...
        <div class="col-md-4 mb-4" data-aos="fade-up">
          <div class="media block-icon-1 d-block text-center">
            <div class="icon mb-3">
              <img src="<?php echo e(asset('landing_page/images/flaticon/svg/004-gear.svg')); ?>" alt="Image" class="img-fluid">
            </div>
            <div class="media-body">
        ...
        <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="100">
          <div class="media block-icon-1 d-block text-center">
            <div class="icon mb-3">
              <img src="<?php echo e(asset('landing_page/images/flaticon/svg/005-conflict.svg')); ?>" alt="Image" class="img-fluid">
            </div>
            <div class="media-body">
        ...
        <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="200">
          <div class="media block-icon-1 d-block text-center">
            <div class="icon mb-3">
              <img src="<?php echo e(asset('landing_page/images/flaticon/svg/006-meeting.svg')); ?>" alt="Image" class="img-fluid">
            </div>
            <div class="media-body">
        ...
        <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="300">
          <div class="media block-icon-1 d-block text-center">
            <div class="icon mb-3">
              <img src="<?php echo e(asset('landing_page/images/flaticon/svg/007-brainstorming.svg')); ?>" alt="Image" class="img-fluid">
            </div>
            <div class="media-body">
        ...
        <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="500">
          <div class="media block-icon-1 d-block text-center">
            <div class="icon mb-3">
              <img src="<?php echo e(asset('landing_page/images/flaticon/svg/009-brainstorming-2.svg')); ?>" alt="Image" class="img-fluid">
            </div>
            <div class="media-body">
  ...
  <div class="container templateux-section">
    ...
    <div class="d-flex flex-sm-row">
      <a href="#" class="block-thumbnail-1 one-third" style="background-image: url(<?php echo e(asset('landing_page/images/slider-2.jpg')); ?>)" data-aos="fade">
      ...
      <a href="#" class="block-thumbnail-1 two-third" style="background-image: url(<?php echo e(asset('landing_page/images/slider-1.jpg')); ?>)" data-aos="fade" data-aos-delay="100">
        <div class="block-thumbnail-content">
          <h2></h2>
          <span class="post-meta"> &bullet; </span>
        </div>
    ...
    <div class="d-flex flex-column flex-sm-row">
      <a href="#" class="block-thumbnail-1 two-third" style="background-image: url(<?php echo e(asset('landing_page/images/slider-1.jpg')); ?>)" data-aos="fade" data-aos-delay="200">
        <div class="block-thumbnail-content">
          <h2></h2>
          <span class="post-meta">  &bullet; </span>
        </div>
      </a>
      <a href="#" class="block-thumbnail-1 one-third" style="background-image: url(<?php echo e(asset('landing_page/images/slider-1.jpg')); ?>)" data-aos="fade" data-aos-delay="300">
        <div class="block-thumbnail-content">
          <h2></h2>
          <span class="post-meta">  &bullet; </span>
        </div>
...
</html><?php /**PATH /homepages/22/d934631494/htdocs/PAYROLL2/resources/views/welcome.blade.php ENDPATH**/ ?>