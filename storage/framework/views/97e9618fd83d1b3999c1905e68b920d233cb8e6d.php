<?php $__env->startSection('title'); ?> Create Schedule <?php $__env->stopSection(); ?>
     ...
     <div class="col-lg-8">
        <div class="page-header-title">
           ...
           <div class="d-inline">
              ...
              <span>Create Schedule, Please fill all fields correctly.</span>
          </div>
      </div>
  </div>
  <div class="col-lg-4">
    <nav class="breadcrumb-container" aria-label="breadcrumb">
       <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item">
             <a href="<?php echo e(route('admin.schedule.index')); ?>">Schedule</a>
         </li>
    ...
    <div class="col-md-6 col-sm-12 col-xl-6 offset-md-3 offset-xl-3">
        ...
        <div class="widget overflow-visible">
            ...
            <div class="widget-body">
                ...
                <form action="<?php echo e($form_store); ?>" method="POST" id="createSchedule">
                    <?php echo csrf_field(); ?>
...
<input type="hidden" name="security_number" value="<?php echo e(Auth::user()->security_number); ?>"/>
                    ...
                    <a href="<?php echo e(route('admin.schedule.index')); ?>" class="btn btn-light"><i class="ik arrow-left ik-arrow-left"></i> Go Back</a>
                </form>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\COMPANY\HUMAN-RESOURCE\resources\views/admin/schedule/create.blade.php ENDPATH**/ ?>