<?php $__env->startSection('title'); ?> Third Party <?php $__env->stopSection(); ?>
    ...
    <div class="col-lg-4">
      <nav class="breadcrumb-container" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            <a href="<?php echo e(route('admin.cashadvance.index')); ?>">Third Party Services</a>
          </li>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $("#linked_employees_data_table").DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('admin.linked_employees_getDataTable')); ?>",
        columns: [
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /homepages/22/d934631494/htdocs/PAYROLL2/resources/views/admin/ThirdPartyDeductions/content.blade.php ENDPATH**/ ?>