...
<form method="post" action="<?php echo e(route('employees.sign_in_submit')); ?>">
  <?php echo csrf_field(); ?>
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text"  name="time_in" value="<?php echo e(date('H:i:s', strtotime($time_in))); ?>" class="form-control"  id="installments" readonly>
...
<?php echo $__env->make('employees/footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /homepages/22/d934631494/htdocs/PAYROLL2/resources/views/employees/attendance/attendance.blade.php ENDPATH**/ ?>