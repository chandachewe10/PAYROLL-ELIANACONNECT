<?php $__env->startSection('title'); ?> Invite Employee <?php $__env->stopSection(); ?>
  ...
  <div class="col-lg-4">
    <nav class="breadcrumb-container" aria-label="breadcrumb">
       <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item">
             <a href="<?php echo e(route('admin.employee.index')); ?>">Employees</a>
         </li>
    ...
    <div class="col-md-8 col-sm-12 col-xl-8 offset-md-2 offset-xl-2">
        ...
        <div class="widget overflow-visible">
            ...
            <div class="widget-body">
                ...
                <form action="<?php echo e($form_store); ?>" method="POST" enctype="multipart/form-data" id="createEmployee">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                       ...
                       <div class="form-group">
                        ...
                        <select class="form-control" name="schedule_id" id="schedule_id">
                          <?php $__currentLoopData = $schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($schedule->id); ?>"><?php echo e($schedule->time_in.'-'.$schedule->time_out); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div class="row">
                      <div class="col-md-6 col-lg-6 col-sm-12">
                       ...
                       <select class="form-control" name="rate_per_hour" id="position_id">
                          <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e(($position->salary_scale * 12) / (40 * 52)); ?>"> For <?php echo e($position->title); ?> -  ZMW <?php echo e(number_format(($position->salary_scale * 12) / (40 * 52),2)); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                      ...
                      <div class="col-md-6 col-lg-6 col-sm-12">
                       ...
                       <label for="Salary">Salary</label><small class="text-danger">*</small>
                        <select class="form-control" name="salary" id="position_id">
                          <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($position->salary_scale); ?>"> For <?php echo e(($position->title)); ?> - ZMW <?php echo e(number_format($position->salary_scale,2)); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-6 col-sm-12">
                       <div class="form-group">
                        ...
                        <input type="number" name="security_number" value="<?php echo e(Auth::user()->security_number); ?>" class="form-control" id="ecurity_number" readonly>
  ...
  -->
                      <div class="col-md-6 col-lg-6 col-sm-12 hidden" id="show-avatar-div">
                        <div class="form-group my-auto">
                          ...
                          <img src="<?php echo e(asset('admin_assets/avatars/merchant/thumb/male.png')); ?>" class="circle-temp" id="avatar-profile">
                        </div>
                      </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /homepages/22/d934631494/htdocs/PAYROLL2/resources/views/admin/employee/create.blade.php ENDPATH**/ ?>