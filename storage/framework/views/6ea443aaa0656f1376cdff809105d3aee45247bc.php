  ...
  <div class="tab-pane fade active show" id="live" role="tabpanel" aria-labelledby="pills-timeline-tab">
    ...
    <div class="card-header">
      <div class="col-md-6 d-block">
        <a href="javascript:void(0)" class="btn btn-sm btn-dark float-left"></i> Attendance</a>
      </div>
...
<script type="text/javascript">
  ...
  var merchantDataTable = $("table#overtime_data_table").DataTable({
    ...
    "ajax": {
      "url": "<?php echo e($getAttendedEmployeesTable); ?>",
      "type": "POST"
    },
...
</script><?php /**PATH /homepages/22/d934631494/htdocs/PAYROLL2/resources/views/admin/attendance/attended.blade.php ENDPATH**/ ?>