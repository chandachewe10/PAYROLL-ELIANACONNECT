...
<button type="button" class="btn btn-info btn-lg btn-block"><i class="fa fa-map-marker"></i><a style="color:white" href="<?php echo e(route("employees.sign_in")); ?>"> Check In</a></button>
                              ...
                              Checked Out: <?php echo e($logged_out->time_out); ?>
                                     ...
                                     <?php else: ?> 
                                     <button type="button" class="btn btn-danger btn-lg btn-block"><i class="fa fa-map-marker"></i><a style="color:white" href="<?php echo e(route("employees.sign_out")); ?>"> Check Out</a></button>
...
<?php endif; ?>
<!--Employee Dashboard Ends here--><?php /**PATH /homepages/22/d934631494/htdocs/PAYROLL2/resources/views/employees/dashboard.blade.php ENDPATH**/ ?>