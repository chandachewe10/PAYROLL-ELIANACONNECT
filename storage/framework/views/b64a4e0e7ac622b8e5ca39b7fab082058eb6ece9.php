...
<?php $__env->startSection('title'); ?> Create Overtime <?php $__env->stopSection(); ?>
  ...
  <div class="col-lg-4">
    <nav class="breadcrumb-container" aria-label="breadcrumb">
       <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item">
             <a href="<?php echo e(route('admin.overtime.index')); ?>">Overtimes</a>
         </li>
    ...
    <div class="col-md-6 col-sm-12 col-xl-6 offset-md-3 offset-xl-3">
        ...
        <div class="widget overflow-visible">
            ...
            <div class="widget-body">
                ...
                <form action="<?php echo e($form_store); ?>" method="POST" enctype="multipart/form-data" id="createOvertime">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                       ...
                       <div class="form-group">
                        ...
                        <select class="form-control" name="employee_id" id="employee_id">
                          <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($employee->id); ?>"><?php echo e($employee->first_name." ".$employee->last_name." (#".$employee->employee_id.")"); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /homepages/22/d934631494/htdocs/PAYROLL2/resources/views/admin/overtime/create.blade.php ENDPATH**/ ?>