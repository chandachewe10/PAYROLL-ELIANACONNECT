...
<?php echo $__env->make('sweetalert::alert', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <div class="js-animsition animsition" id="site-wrap" data-animsition-in-class="fade-in" data-animsition-out-class="fade-out">
        ...
        <div class="row">
          ...
          <nav class="col-9 site-nav">
            ...
            <ul class="sf-menu templateux-menu d-none d-md-block">
              <li class="active">
                <a href="<?php echo e(('/')); ?>" class="animsition-link">Home</a>
              </li>
              <li><a href="<?php echo e(route('login')); ?>" class="animsition-link">Employer Login</a></li>
              <li>
    ...
    <div class="templateux-cover" style="background-image: url(<?php echo e(asset('landing_page/images/slider-1.jpg')); ?>)">
      <div class="container">
    ...
    <footer class="templateux-footer bg-light">
      ...
      </html><?php /**PATH /homepages/22/d934631494/htdocs/PAYROLL2/resources/views/contact_us.blade.php ENDPATH**/ ?>