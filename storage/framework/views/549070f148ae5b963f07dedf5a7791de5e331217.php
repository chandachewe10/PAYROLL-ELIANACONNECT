    ...
    <div class="col-lg-8">
      <div class="page-header-title">
        ...
        <div class="d-inline">
          ...
          <span>You can show and manage Third Party Service Providers from here.</span>
        </div>
      </div>
    </div>
    <div class="col-lg-4">
      <nav class="breadcrumb-container" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">List of Third Party Service Providers</li>
        </ol>
      </nav>
    </div>
  </div>
      ...
      <div class="card">
        ...
        <div class="tabs_contant">
          <div class="card-header">
            <h5>List of Third Party Service Providers</h5>
          </div>
          <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\COMPANY\HUMAN-RESOURCE\resources\views/admin/deduction/index.blade.php ENDPATH**/ ?>